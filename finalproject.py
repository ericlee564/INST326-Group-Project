...
class store():
    ...
    def inventory(item, price, amount):
    ...
    def addinventory(item, price, amount):
        """ Allows employees to add products to current inventory list
        
        Args:
            item(str): string of new item name
            price(int): price of new item
            amount(int): number of new items in inventory
        """
